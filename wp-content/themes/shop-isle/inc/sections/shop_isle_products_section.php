...
if ( current_user_can( 'edit_theme_options' ) ) {
	$shop_isle_products_title = get_theme_mod( 'shop_isle_products_title', __( 'Sản phẩm mới nhất', 'shop-isle' ) );
} else {
...
elseif ( isset( $shop_isle_products_category ) && ! empty( $shop_isle_products_category ) && ( $shop_isle_products_category != '-' ) ) :
	...
	if ( $shop_isle_latest_loop->have_posts() ) :
		...
		if ( function_exists( 'wc_get_page_id' ) ) {
			echo '<a href="' . esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ) . '" class="btn btn-b btn-round">' . apply_filters( 'shop_isle_see_all_products_label', __( 'Xem tất cả sản phẩm', 'shop-isle' ) ) . '</a>';
		} elseif ( function_exists( 'woocommerce_get_page_id' ) ) {
			echo '<a href="' . esc_url( get_permalink( woocommerce_get_page_id( 'shop' ) ) ) . '" class="btn btn-b btn-round">' . apply_filters( 'shop_isle_see_all_products_label', __( 'Xem tất cả sản phẩm', 'shop-isle' ) ) . '</a>';
		}
		echo '</div>';
		echo '</div>';
