		...
		$shop_isle_slider = get_theme_mod('shop_isle_slider', json_encode(
			array(
				...
				array(
					...
					'link' => '#',
					'text' => __( 'SHOPPP','shop-isle' ),
					'subtext' => __( '321WooCommerce Theme','shop-isle' ),
					'label' => __( 'Chi tiết','shop-isle' ),
				),
			)
		));
...
/**
 * Remove the frontpage template if the Lite SHOPPP theme was not from wp.org
 */
